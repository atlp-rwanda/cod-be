...
const sendVerifyEmail = (firstname, verificationUrl) => {
  const message = `
    ...
    <tbody>
        <tr>
        <td style="padding:18px 30px 18px 30px; line-height:40px; text-align:inherit; background-color:#dde6de;" height="100%" valign="top" bgcolor="#dde6de" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #6fab81; font-size: 40px; font-family: inherit">Hi ${firstname}, Thank you for registering with us!</span></div><div></div></div></td>
        </tr>
    </tbody>
    </table>
    ...
    <tbody>
        <tr>
        <td style="padding:18px 50px 18px 50px; line-height:22px; text-align:inherit; background-color:#dde6de;" height="100%" valign="top" bgcolor="#dde6de" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 16px; font-family: inherit">Confirm your email address to start using your travel services.</span></div><div></div></div></td>
        </tr>
    </tbody>
    </table>
