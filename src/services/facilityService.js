...
const getfacility=async (id)=>{
    const getRecord=await Facility.findOne(
        {
            include:[{
                model: Accomodation,as:'accomodation',
                attributes: ['name'],
            },
            {
            ...
            {
                model: FacilityComponent,as:'components',
...
export {addNew, getfacility,removeById,getByAccomodation,addFacilityComponent,
    getFacilityComponents,getComponentById,removeComponent }
